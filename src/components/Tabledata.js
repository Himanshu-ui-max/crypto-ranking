...
export default function Tabledata(props) {
  ...
  <tbody >
    ...
    <tr className='d-flex justify-content-evenly' style={{fontSize:'1.6rem',color:'white',width: '1375px',margin: 'auto'}}>
      ...
      <td className='TabD' style={{width : '300px', textAlign :'left',color:item.price_change_percentage_24h.toFixed(2)>0?'blue':'red'}}>{item.price_change_percentage_24h.toFixed(2)>0?'+'+item.price_change_percentage_24h:item.price_change_percentage_24h}%</td>
